# smoke-check Specification

## Purpose
Dar ao time um jeito de exercitar o fluxo inteiro — importar, sugerir, exportar — contra a
API do modelo de verdade, fora da suíte automatizada, sabendo de antemão quantas chamadas
isso custa contra o limite diário do plano gratuito.
## Requirements
