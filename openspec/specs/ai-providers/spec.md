...
A camada que fala com a IA, e o único lugar do projeto que sabe **qual** IA respondeu.

O resto do sistema pede o que precisa e recebe o resultado; trocar de provedor,
acrescentar um novo ou mudar a ordem de prioridade não toca em nenhuma regra de negócio.
Quando um provedor não pode responder — cota estourada, serviço fora do ar —, o próximo
da fila responde no lugar, sem que o usuário perceba a troca.
